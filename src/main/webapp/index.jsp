...
<body>
	...
	<h2 style="color: violet; font-size: 40px;" align="center">Deployed using jenkins</h2>
	<h2 style="color: cyan; font-size: 40px;" align="center">Deployed using jenkins Poll scm </h2>
